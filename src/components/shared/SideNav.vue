  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img
        ...
        style="opacity: .8"
      />
      <span class="brand-text font-weight-light">THAT CMS</span>
    </a>
        ...
        >
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link
                  :to="{ name: 'userList', query: { page: 1, limit: 20 } }"
                  class="nav-link"
                >
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link
                  :to="{ name: 'supplierList', query: { page: 1, limit: 20 } }"
                  class="nav-link"
                >
                  <i class="fas fa-list nav-icon"></i>
                  <p>List</p>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link :to="{ name: 'productCreate' }" class="nav-link">
                  <i class="fas fa-pencil-alt nav-icon"></i>
                  <p>Create new</p>
                </router-link>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link
                  :to="{ name: 'categoryList', query: { page: 1, limit: 20 } }"
                  class="nav-link"
                >
                  <i class="fas fa-list nav-icon"></i>
                  <p>List</p>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link
                  :to="{ name: 'purchaseList', query: { page: 1, limit: 20 } }"
                  class="nav-link"
                >
                  <i class="fas fa-list nav-icon"></i>
                  <p>List</p>
